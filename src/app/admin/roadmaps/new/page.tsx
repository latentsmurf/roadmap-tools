...
export default async function NewRoadmapPage() {
  await requirePermission("roadmap:create")
  return (
        ...
        <Card className="shadow-2xl border-t-8 border-t-primary overflow-hidden rounded-3xl">
          ...
          <CardContent className="px-10 pb-12">
            <form action={createRoadmap} className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground ml-1">
                    Your roadmap will be accessible at this public URL.
                  </p>
                </div>
              </div>
              ...
              <Button
                type="submit"
                className="w-full h-14 text-lg font-bold rounded-2xl shadow-lg shadow-primary/30 active:scale-[0.98] transition-all"
              >
                Launch Roadmap
              </Button>
            </form>
